...
A: Use -s 10000000000 option
However such files cannot be copied to a FAT filesystem partition.
Also note, files larger than 2GB will not work in the loader,
so it's best to leave the -s option at the default value.
...
wbfs_file.exe 1.8 by oggzee, based on wbfs by kwiirk
