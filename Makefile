...
install:
	make --assume-old="wiithon_wrapper/*.c wiithon_wrapper/*.h wiithon_wrapper/libwbfs/*.c wiithon_wrapper/libwbfs/*.h po/*.po po/plantilla.pot recursos/glade/*.ui.h *.py" install_compilando
